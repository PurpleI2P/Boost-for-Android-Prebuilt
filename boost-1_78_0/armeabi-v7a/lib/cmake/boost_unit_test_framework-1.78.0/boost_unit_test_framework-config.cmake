...
if(EXISTS "/usr/src/boost-android/boost/build/out/armeabi-v7a/lib/cmake")
  get_filename_component(_BOOST_CMAKEDIR_ORIGINAL "/usr/src/boost-android/boost/build/out/armeabi-v7a/lib/cmake" REALPATH)
  if(_BOOST_CMAKEDIR STREQUAL _BOOST_CMAKEDIR_ORIGINAL)
    set(_BOOST_CMAKEDIR "/usr/src/boost-android/boost/build/out/armeabi-v7a/lib/cmake")
  endif()
...
foreach(dep_boost_unit_test_framework IN LISTS _BOOST_UNIT_TEST_FRAMEWORK_DEPS)
  ...
  find_package(boost_${dep_boost_unit_test_framework} 1.78.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})
